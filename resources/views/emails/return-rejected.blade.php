                ...
                <tr>
                    <td style="padding:22px 24px;">
                        ...
                        <div style="font-size:14px; line-height:1.6; color:#333;">
                            We've reviewed your return request for order <strong>{{ $reference }}</strong>. Unfortunately, we're unable to approve this return at this time.
                        </div>
                        ...
                        <div style="font-size:12px; color:#666; line-height:1.6; text-align:center;">
                            If you have any questions, please contact us at <a href="mailto:info@rjbeautylounge.com" style="color:#4C3715;">info@rjbeautylounge.com</a>
