                ...
                <tr>
                    <td style="padding:22px 24px; background:#FF8C00; color:#fff;">
                        ...
                        <div style="font-size:13px; opacity:0.9; margin-top:10px;">
                            Booking Rescheduled • {{ $b['reference'] ?? ('#' . ($b['id'] ?? '')) }}
                            @if($isMultiDate)
                ...
                <tr>
                    <td style="padding:22px 24px;">
                        ...
                        <div style="font-size:14px; line-height:1.6; color:#333;">
                            Your booking has been rescheduled. Below are your updated booking details.
                        </div>

                        <div style="height:16px;"></div>

                        @if($b['previousDate'] || $b['previousStartTime'])
                        <div style="background:#FFF3CD; border-radius:12px; padding:14px; margin-bottom:16px;">
                            <div style="font-size:13px; font-weight:700; color:#856404; margin-bottom:8px;">Previous Schedule</div>
                            <div style="font-size:13px; color:#856404;">
                                @if($b['previousDate'])
                                <span style="text-decoration:line-through;">{{ $b['previousDate'] }}</span>
                                @endif
                                @if($b['previousStartTime'])
                                at <span style="text-decoration:line-through;">{{ $b['previousStartTime'] }} - {{ $b['previousEndTime'] ?? '' }}</span>
                                @endif
                            </div>
                        </div>
                        @endif
