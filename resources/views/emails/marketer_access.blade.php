...
<head>
    ...
    <title>Marketer access for Romeo & Juliet Beauty Lounge</title>
</head>
            ...
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="background:#fff; border-radius:14px; overflow:hidden; box-shadow:0 8px 30px rgba(0,0,0,0.06);">
                <tr>
                    <td style="padding:22px 24px; background:#111; color:#fff;">
                        <div style="font-size:18px; font-weight:700;">📊 Marketer Access Granted</div>
                ...
                <tr>
                    <td style="padding:22px 24px;">
                        ...
                        <div style="font-size:14px; line-height:1.6; color:#333;">
                            You've been granted <strong>marketer status</strong> for <strong>Romeo & Juliet Beauty Lounge</strong>.
                        </div>

                        <div style="height:16px;"></div>

                        <div style="font-size:14px; line-height:1.6; color:#333;">
                            Use the link below to access your marketer panel:
                        </div>
