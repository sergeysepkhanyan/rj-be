...
class CheckoutCartRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shippingAddress.mobile' => ['required_without:shippingAddressId', 'string'],
            ...
            'billingAddress.mobile' => ['required_without_all:billingAddressId,billingSameAsShipping', 'string'],
