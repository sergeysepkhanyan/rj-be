...
use App\Repositories\BookingSelectionRepository;
...
use App\Repositories\TrackingConfigRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(BookingSelectionRepositoryInterface::class, BookingSelectionRepository::class);
        ...
        $this->app->bind(PageSeoRepositoryInterface::class, PageSeoRepository::class);
        $this->app->bind(TrackingConfigRepositoryInterface::class, TrackingConfigRepository::class);
        $this->app->bind(DiscountSettingRepositoryInterface::class, DiscountSettingRepository::class);
